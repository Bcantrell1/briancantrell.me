      ...
      {isSubmitted ? (
        ...
        <form onSubmit={handleSubmit} className={styles.messaging}>
          ...
          <textarea
            ...
            required
          />
          <button className={`${styles.buttonStyle} ${styles.default}`} type="submit" disabled={isLoading}>
        ...
        <div className={styles.messageToJson}>
          ...
          <div className={styles.dataObject}>
            ...
            <div className={styles.set}>
              ...
              <p className={styles.results} style={{ whiteSpace: 'pre-line' }}>
                {message}
              </p>
            </div>
            <div className={styles.set}>
              <span className={styles.options}>date</span>
              <p className={styles.results}>{formatDate(currentDate)}</p>
            </div>
          </div>
        </div>
      </div>
