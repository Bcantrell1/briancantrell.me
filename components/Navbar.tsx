		...
		<header className={styles.header}>
			...
			<div className={styles.container}>
				...
				<nav className={styles.nav}>
					<Link href={'/'} className={`${styles.subNavs} ${isActive('/') ? styles.active : ''}`}>
						_home
					</Link>
					<Link href={'/about'} className={`${styles.subNavs} ${isActive('/about') ? styles.active : ''}`}>
						_about-me
					</Link>
					<Link href={'/projects'} className={`${styles.subNavs} ${isActive('/projects') ? styles.active : ''}`}>
						_projects
					</Link>
				</nav>
				{/* <LangToggle /> */}
				<Link href={'/contact'} className={`${styles.contact} ${styles.subNavs} ${isActive('/contact') ? styles.active : ''}`}>
					_contact-me
				</Link>
			</div>
